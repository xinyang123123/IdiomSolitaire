...
@DatabaseView(
    ...
    value = "SELECT idiom_info.IDIOM, idiom_info.PINYIN ,idiom_info.FIRST_PINYIN,idiom_info.LAST_PINYIN,idiom_info.DESCRIPTION, idiom_count.COUNT FROM idiom_count INNER JOIN idiom_info ON idiom_info.LAST_PINYIN = idiom_count.PINYIN "
)
